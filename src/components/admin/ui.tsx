...
export const adminInput =
  "w-full rounded-xl border border-line bg-white/80 px-3.5 py-2.5 text-sm text-ink outline-none transition-colors placeholder:text-ink-soft/50 focus:border-terracotta";
...
export function SubmitButton({
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-[10px] font-medium tracking-[0.18em] uppercase transition-colors disabled:opacity-50 ${styles} ${className}`}
    >
