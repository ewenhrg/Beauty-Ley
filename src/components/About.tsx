    ...
    <section className="relative">
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 py-20 sm:px-8 lg:grid-cols-2 lg:gap-16 lg:py-28">
        ...
        <div className="relative z-10 pt-10 lg:pt-0 lg:pl-4">
          ...
          <Reveal as="p" delay={180} className="mt-8 max-w-md text-base leading-8 text-ink-soft">
            {t("about.body")}
          </Reveal>
          <dl className="mt-10 grid max-w-md grid-cols-2 gap-x-6 gap-y-8">
            <Reveal as="div" delay={240}>
              <dt className="text-[11px] tracking-[0.2em] text-rose uppercase">{t("about.place")}</dt>
              <dd className="mt-2 font-display text-2xl">Hurghada</dd>
            </Reveal>
            <Reveal as="div" delay={300}>
              <dt className="text-[11px] tracking-[0.2em] text-rose uppercase">{t("about.studio")}</dt>
              <dd className="mt-2 font-display text-2xl">{t("about.studioValue")}</dd>
            </Reveal>
          </dl>
        </div>
      </div>
